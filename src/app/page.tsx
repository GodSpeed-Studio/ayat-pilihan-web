...
  const quoteCardRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    ...
    if (isInstagramBrowser) {
      // Beri jeda 500 milidetik (setengah detik) untuk memastikan halaman tergambar dulu
      const timer = setTimeout(() => {
        openInExternalBrowser();
      }, 500);

      // Membersihkan timer jika pengguna pindah halaman sebelum waktunya habis
...
  }, [verse]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Tidak ada lagi dialog buatan kita, hanya modal untuk preview gambar */}
      {modalImage && (
