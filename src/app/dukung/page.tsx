  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4 sm:p-8">
      <div className="max-w-xl w-full bg-white rounded-lg shadow-xl p-6 sm:p-10 text-center">
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Dukung via QRIS</h2>
          {/* Ganti "LINK_GAMBAR_QRIS_ANDA.png" dengan link gambar QRIS Anda yang sebenarnya */}
          <div className="flex justify-center">
            <img 
              src="/qris-placeholder.png" // Ini adalah gambar placeholder
              alt="QR Code Donasi QRIS" 
              className="w-64 h-64 border-4 border-gray-200 rounded-lg" 
            />
          </div>
          <p className="text-sm text-gray-500 mt-2">(Bisa di-scan dari semua E-Wallet dan Mobile Banking)</p>
        </div>
